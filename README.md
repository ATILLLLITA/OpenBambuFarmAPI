...
Findings come from controlled captures of official Farm Manager 2.x sessions between
**one** server and **one** printer (model C12, firmware `01.06.30.01`) on a private LAN, then
